...
public:
    ...
    QPushButton *btnP;
    QPlainTextEdit *txtEscritorios;
    QPlainTextEdit *txtHangaresMantenimiento;
    ...
    void setupUi(QMainWindow *Principal)
    {
        ...
        btnP->setFlat(true);
        txtEscritorios = new QPlainTextEdit(gbDatos);
        txtEscritorios->setObjectName(QStringLiteral("txtEscritorios"));
        txtEscritorios->setGeometry(QRect(430, 80, 261, 31));
        txtHangaresMantenimiento = new QPlainTextEdit(gbDatos);
        txtHangaresMantenimiento->setObjectName(QStringLiteral("txtHangaresMantenimiento"));
        txtHangaresMantenimiento->setGeometry(QRect(160, 80, 261, 31));
        ...
        lblEquipaje->setGeometry(QRect(290, 800, 1071, 181));
        ...
        txtConsola = new QPlainTextEdit(centralWidget);
        txtConsola->setObjectName(QStringLiteral("txtConsola"));
        txtConsola->setGeometry(QRect(1380, 800, 531, 241));
        QPalette palette1;
        ...
        txtConsola->setPalette(palette1);
    ...
    void retranslateUi(QMainWindow *Principal)
    {
        ...
        txtEscritorios->setDocumentTitle(QString());
        txtEscritorios->setPlainText(QString());
        txtEscritorios->setPlaceholderText(QApplication::translate("Principal", "Numero de Escritorios", Q_NULLPTR));
        txtHangaresMantenimiento->setDocumentTitle(QString());
        txtHangaresMantenimiento->setPlainText(QString());
        txtHangaresMantenimiento->setPlaceholderText(QApplication::translate("Principal", " Numero de Hangares de Mantenimiento", Q_NULLPTR));
        ...
        txtConsola->setPlainText(QString());
    } // retranslateUi
